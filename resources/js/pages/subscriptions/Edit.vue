...
const form = useForm({
    user_id: String(props.subscription.user_id),
    package_id: props.subscription.package_id,
});
...
const submit = () => form.put(route('subscriptions.update', props.subscription.id));
</script>
        ...
        <div class="p-4">
            <Form @submit="submit">
                ...
                <div class="flex justify-center space-x-4 pt-6">
                    ...
                    <Button variant="success" type="submit" class="w-64" :disabled="form.processing">Update</Button>
                </div>
            </Form>
        </div>
    </AppLayout>
